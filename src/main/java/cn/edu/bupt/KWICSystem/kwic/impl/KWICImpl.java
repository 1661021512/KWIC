...
import cn.edu.bupt.KWICSystem.dao.jdbcUtils;
...
public class KWICImpl extends Thread implements KWIC {
    ...
    private final int DB_ADD_LINE = 105;
    ...
    public void execute() throws Exception {
        ...
        while (!"q".equals(line)) {
            ...
            if (flag == 0) {
                ...
                String sql = "SELECT content FROM kwicinput";
...
//                        RabbitMq.getConnection();
                ...
                if (shifter.getLineCount() == 0) {
                    ...
                    // 输出排序后的结果
                    if (cmdCode == CMD_ADD_LINE || cmdCode == MQ_ADD_LINES || cmdCode == DB_ADD_LINE) {
